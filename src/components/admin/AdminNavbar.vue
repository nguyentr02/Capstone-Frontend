  ...
  <div class="bg-white shadow-sm d-flex align-items-center justify-content-between px-4" style="height: 4rem;">
    ...
    <div class="d-flex align-items-center gap-3">
      ...
      <div class="position-relative">
        ...
        <span class="position-absolute bg-danger text-white rounded-circle d-flex align-items-center justify-content-center" style="top: -0.25rem; right: -0.25rem; width: 1.25rem; height: 1.25rem;">
          5
        </span>
      </div>
      ...
      <div class="d-flex align-items-center" style="cursor: pointer;" @click="toggleUserMenu">
        ...
        <div v-if="isUserMenuOpen" class="position-absolute end-0 bg-white shadow-lg rounded py-2" style="top: 3rem; width: 12rem; z-index: 10;">
...
.no-border-btn:hover {
  background-color: #e9ecef; /* 灰色背景，可根据需要调整 */
}
</style>