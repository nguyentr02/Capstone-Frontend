<template>
    <div class="homepage">
      <header>
        ...
        <h1 style="width: 80%">Registration Management</h1>
        <hr />
      ...
      <main class="homepage-body">
        <div class="report-selection-export-container">
            ...
            <div class = "report-selection">
                <h1 style="margin-top: 10px;">User Registration List</h1>
                <div class="search-bar-noti-container">
            ...
            <tbody>
                <tr>
                    ...
                    <th>Questionnaire completion status</th>
                </tr>
                <tr>
                    <td>Barry Allen</td>
                    <td>Marathon Competition</td>
                    <td>3:00 pm 20/11/2024</td>
                    <td>Successful</td>
                    <td>Not completed</td>
                </tr>
                <tr>
