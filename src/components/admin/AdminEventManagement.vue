    ...
    <main class="homepage-body">
      <div class="report-selection-export-container">
        ...
        <div class = "report-selection">
          <h1 style="margin-top: 10px;">Event List</h1>
          <div class="search-bar-noti-container">
      ...
      <div class="container" id="top-container">
        <div class="reportCard">
          ...
          <div style="margin-bottom: 3%;">
            <span class="report-field-title">Start Date: </span>
            <span>2/10/2024</span>
          </div>
          <div style="margin-bottom: 3%;">
            <span class="report-field-title">End Date: </span>
            <span>2/10/2024</span>
          </div>
          <div style="margin-bottom: 3%;">
            <span class="report-field-title">Current Status: </span>
