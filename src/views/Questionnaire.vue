...
const teamOption = ref("");  // Responsive variables with new team options
...
const goToReview = () => {
  router.push({
    ...
    query: { 
      ...
      teamOption: teamOption.value   // Pass the team selections to the next page
    },
  });
};
